...
import weather.tracker.app.init.TestDataInitializer;
...
public class DevelopmentConfiguration {
    ...
    public DriverManagerDataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/weather-tracker?loglevel=0");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DriverManagerDataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[]{"weather.tracker.app.model"});
